...
S1 = load('F:\ABC参数实验结果\NP组\Sphere\04result.txt');
[a,c] = size(S1);
...
S1 = load('F:\ABC参数实验结果\NP组\Sphere\06result.txt');
for i=1:a
    for j=1:avecycle
...
S1 = load('F:\ABC参数实验结果\NP组\Sphere\10result.txt');
for i=1:a
    for j=1:avecycle
...
S1 = load('F:\ABC参数实验结果\NP组\Sphere\30result.txt');
for i=1:a
    for j=1:avecycle
...
S1 = load('F:\ABC参数实验结果\NP组\Sphere\50result.txt');
for i=1:a
    for j=1:avecycle
